    ...
    return (
        <div className="container mx-auto my-16 flex flex-col lg:flex-row items-center py-8 px-4 lg:py-16">
            <div className="text-container text-center lg:text-left lg:mr-8">
                ...
                <p className="text-4xl font-bold bg-gradient-to-r from-orange-200 to-orange-400 text-transparent bg-clip-text">Développez votre activité locale.</p>
                <p className="mb-8 text-4xl font-bold bg-gradient-to-r from-violet-200 to-violet-400 text-transparent bg-clip-text">Des professionnels près de chez vous.</p>
                <p className='mt-8 text-white'>La plateforme idéale pour connecter les petites entreprises locales avec les clients à la recherche de leurs services.</p>
