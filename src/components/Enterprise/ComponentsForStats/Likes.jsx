...
export default function Likes() {
  ...
  return (
    <div className="bg-orange-100 bg-opacity-30 dark:bg-neutral-700 text-black dark:text-white shadow-md rounded-lg p-6 flex items-center space-x-4 w-56 h-32">
      ...
      <div>
        <h2 className="text-xl font-bold bg-gradient-to-r from-violet-400 to-violet-800 dark:bg-gradient-to-r dark:from-violet-200 dark:to-violet-400 text-transparent bg-clip-text">
          Favoris</h2>
