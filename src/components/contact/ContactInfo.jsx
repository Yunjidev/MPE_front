...
const ContactInfo = () => {
  return (
    <div className="p-4">
      <h2 className="bg-gradient-to-r dark:from-green-200 dark:to-green-400 from-violet-400 to-violet-600 text-transparent bg-clip-text text-4xl font-bold">
        Nous contacter
      </h2>
      <p className="mt-2 dark:text-gray-100 text-xl">
