...
export default function StatsEnterprises() {
  return (
    <div className="flex flex-col items-center justify-center p-4 lg:p-8 mx-auto max-w-5xl">
      <h1 className="text-4xl font-bold mb-8 bg-gradient-to-r from-white to-[#67FFCC] dark:bg-gradient-to-r dark:from-white dark:to-[#67FFCC] text-transparent bg-clip-text text-center">
        Vos Statistiques
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-0 w-full">
        <Likes />
        <LenghtSearch />
        <LenghtView />
        <LengthReservation />
