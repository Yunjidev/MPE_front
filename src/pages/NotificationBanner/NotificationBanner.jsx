...
const CookieBanner = () => {
  ...
  return (
    <section className="fixed max-w-2xl items-center p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 left-12 bottom-16 dark:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl z-50">
      <div className="flex items-center gap-x-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">Nous utilisons des cookies pour vous garantir la meilleure expérience sur notre site web. <a href="/cookie-policies" className="text-blue-500 hover:underline">Lisez notre politique de cookies</a>.</p>
      </div>
