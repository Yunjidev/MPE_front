...
const ConfidentialityPolicies = () => {
    return (
        <div className="max-w-2xl mx-auto p-4 mt-8">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">2. Utilisation des données</h2>
            <p className="dark:text-white text-gray-700 mb-4">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">3. Partage des données</h2>
            <p className="dark:text-white text-gray-700 mb-4">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">4. Sécurité des données</h2>
            <p className="dark:text-white text-gray-700 mb-4">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">5. Vos droits</h2>
            <p className="dark:text-white text-gray-700 mb-4">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">7. Modifications de la politique de confidentialité</h2>
            <p className="dark:text-white text-gray-700 mb-4">
