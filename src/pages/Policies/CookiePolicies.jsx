...
const CookiePolicies = () => {
  return (
    <div className="max-w-2xl mx-auto p-4 mt-8">
      <h1 className="dark:text-orange-800 text-3xl font-bold mb-6">Politique de Cookies</h1>
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Que sont les cookies ?</h2>
      <p className="dark:text-white text-gray-700 mb-4">
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Quels types de cookies utilisons-nous ?</h2>
      <p className="dark:text-white text-gray-700 mb-4">
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Comment utilisons-nous les cookies ?</h2>
      <p className="dark:text-white text-gray-700 mb-4">
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Gestion des cookies et consentement</h2>
      <p className="dark:text-white text-gray-700 mb-4">
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Cookies utilisés sur notre site</h2>
      <p className="dark:text-white text-gray-700 mb-4">
      ...
      <table className="dark:text-white table-auto w-full text-left border-collapse border border-gray-300 mb-6">
        <thead>
          <tr>
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Modifications de cette politique</h2>
      <p className="dark:text-white text-gray-700 mb-4">
      ...
      <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">Contact</h2>
      <p className="dark:text-white text-gray-700 mb-4">
