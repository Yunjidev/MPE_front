...
const UsagePolicies = () => {
    return (
        <div className="max-w-2xl mx-auto p-4 mt-8">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">2. Accès au Site</h2>
            <p className="dark:text-white text-gray-700 mb-4">
            ...
            <h2 className="dark:text-orange-800 text-xl font-semibold mt-6">3. Inscription et compte utilisateur</h2>
            <p className="dark:text-white text-gray-700 mb-4">
